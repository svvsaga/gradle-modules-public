...
@XmlEnum
public enum LocationCodeTypeEnum2 {
    ...
    LocationCodeTypeEnum2(String v) {
        value = v;
    }
    ...
    public static LocationCodeTypeEnum2 fromValue(String v) {
        for (LocationCodeTypeEnum2 c: LocationCodeTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
