...
@XmlEnum
public enum CctvCameraFaultEnum2 {
    ...
    public static CctvCameraFaultEnum2 fromValue(String v) {
        for (CctvCameraFaultEnum2 c: CctvCameraFaultEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
