...
public enum PoorEnvironmentTypeEnum2 {
    ...
    PoorEnvironmentTypeEnum2(String v) {
        value = v;
    }
    ...
    public static PoorEnvironmentTypeEnum2 fromValue(String v) {
        for (PoorEnvironmentTypeEnum2 c: PoorEnvironmentTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
