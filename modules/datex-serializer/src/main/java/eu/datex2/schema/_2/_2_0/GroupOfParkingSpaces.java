    ...
    extends ParkingSpaceBasics
{
    ...
    protected List<_GroupOfParkingSpacesParkingSpaceIndexParkingSpace> parkingSpace;
    protected GroupOfLocations groupOfLocations;
    protected _ExtensionType groupOfParkingSpacesExtension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link _GroupOfParkingSpacesParkingSpaceIndexParkingSpace }
     * 
     * 
     */
    public List<_GroupOfParkingSpacesParkingSpaceIndexParkingSpace> getParkingSpace() {
        if (parkingSpace == null) {
            parkingSpace = new ArrayList<_GroupOfParkingSpacesParkingSpaceIndexParkingSpace>();
        }
     ...
     *     
     */
    public _ExtensionType getGroupOfParkingSpacesExtension() {
     ...
     *     
     */
    public void setGroupOfParkingSpacesExtension(_ExtensionType value) {
