...
@XmlEnum
public enum LocationCodeSubTypeEnum2 {
    ...
    LocationCodeSubTypeEnum2(String v) {
        value = v;
    }
    ...
    public static LocationCodeSubTypeEnum2 fromValue(String v) {
        for (LocationCodeSubTypeEnum2 c: LocationCodeSubTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
