...
@XmlEnum
public enum CctvCameraControlAvailabilityEnum2 {
    ...
    CctvCameraControlAvailabilityEnum2(String v) {
        value = v;
    }
    ...
    public static CctvCameraControlAvailabilityEnum2 fromValue(String v) {
        for (CctvCameraControlAvailabilityEnum2 c: CctvCameraControlAvailabilityEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
