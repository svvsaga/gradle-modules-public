...
@XmlEnum
public enum CctvCameraVideoOrImageAvailabilityEnum2 {
    ...
    CctvCameraVideoOrImageAvailabilityEnum2(String v) {
        value = v;
    }
    ...
    public static CctvCameraVideoOrImageAvailabilityEnum2 fromValue(String v) {
        for (CctvCameraVideoOrImageAvailabilityEnum2 c: CctvCameraVideoOrImageAvailabilityEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
