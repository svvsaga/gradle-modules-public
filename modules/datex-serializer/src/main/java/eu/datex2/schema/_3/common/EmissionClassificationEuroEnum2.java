...
public enum EmissionClassificationEuroEnum2 {
    ...
    EmissionClassificationEuroEnum2(String v) {
        value = v;
    }
    ...
    public static EmissionClassificationEuroEnum2 fromValue(String v) {
        for (EmissionClassificationEuroEnum2 c: EmissionClassificationEuroEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
