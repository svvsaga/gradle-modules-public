 ...
 * 
 */
@XmlType(name = "PrecipitationTypeEnum", namespace = "http://datex2.eu/schema/3/common")
@XmlEnum
public enum PrecipitationTypeEnum2 {
    ...
    PrecipitationTypeEnum2(String v) {
        value = v;
    }
    ...
    public static PrecipitationTypeEnum2 fromValue(String v) {
        for (PrecipitationTypeEnum2 c: PrecipitationTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
