 ...
 * 
 */
@XmlType(name = "WeatherRelatedRoadConditionTypeEnum", namespace = "http://datex2.eu/schema/3/common")
@XmlEnum
public enum WeatherRelatedRoadConditionTypeEnum2 {
    ...
    WeatherRelatedRoadConditionTypeEnum2(String v) {
        value = v;
    }
    ...
    public static WeatherRelatedRoadConditionTypeEnum2 fromValue(String v) {
        for (WeatherRelatedRoadConditionTypeEnum2 c: WeatherRelatedRoadConditionTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
