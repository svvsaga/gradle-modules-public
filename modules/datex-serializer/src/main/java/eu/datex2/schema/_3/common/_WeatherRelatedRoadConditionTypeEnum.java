...
public class _WeatherRelatedRoadConditionTypeEnum {

    @XmlValue
    protected WeatherRelatedRoadConditionTypeEnum value;
     ...
     *     
     */
    public WeatherRelatedRoadConditionTypeEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(WeatherRelatedRoadConditionTypeEnum value) {
        this.value = value;
    }
