...
/**
 * A single point on the road network defined by reference to a pre-defined ALERT-C location
 *         table and which has an associated direction of traffic flow.
 *       
 * 
 ...
 *         &lt;element name="_alertCPointExtension" type="{http://datex2.eu/schema/3/common}_ExtensionType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
