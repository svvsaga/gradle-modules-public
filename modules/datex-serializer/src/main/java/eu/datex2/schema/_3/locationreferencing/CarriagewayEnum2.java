 ...
 * 
 */
@XmlType(name = "CarriagewayEnum", namespace = "http://datex2.eu/schema/3/locationReferencing")
@XmlEnum
public enum CarriagewayEnum2 {
    ...
    public static CarriagewayEnum2 fromValue(String v) {
        for (CarriagewayEnum2 c: CarriagewayEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
