...
public enum GeographicCharacteristicEnum2 {
    ...
    GeographicCharacteristicEnum2(String v) {
        value = v;
    }
    ...
    public static GeographicCharacteristicEnum2 fromValue(String v) {
        for (GeographicCharacteristicEnum2 c: GeographicCharacteristicEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
