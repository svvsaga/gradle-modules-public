...
@XmlEnum
public enum InfrastructureDescriptorEnum {
    ...
    InfrastructureDescriptorEnum(String v) {
        value = v;
    }
    ...
    public static InfrastructureDescriptorEnum fromValue(String v) {
        for (InfrastructureDescriptorEnum c: InfrastructureDescriptorEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
