...
/**
 * A linear section along a linear element where the linear element is either a part of or
 *         the whole of a linear object (i.e. a road), consistent with ISO 19148 definitions.
 *       
 * 
