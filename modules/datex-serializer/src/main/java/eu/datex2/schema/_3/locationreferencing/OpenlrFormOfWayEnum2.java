 ...
 * 
 */
@XmlType(name = "OpenlrFormOfWayEnum", namespace = "http://datex2.eu/schema/3/locationReferencing")
@XmlEnum
public enum OpenlrFormOfWayEnum2 {
    ...
    public static OpenlrFormOfWayEnum2 fromValue(String v) {
        for (OpenlrFormOfWayEnum2 c: OpenlrFormOfWayEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
