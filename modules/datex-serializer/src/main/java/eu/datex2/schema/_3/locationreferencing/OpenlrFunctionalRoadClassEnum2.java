...
public enum OpenlrFunctionalRoadClassEnum2 {
    ...
    OpenlrFunctionalRoadClassEnum2(String v) {
        value = v;
    }
    ...
    public static OpenlrFunctionalRoadClassEnum2 fromValue(String v) {
        for (OpenlrFunctionalRoadClassEnum2 c: OpenlrFunctionalRoadClassEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
