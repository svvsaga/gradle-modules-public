...
public enum PositionConfidenceCodedErrorEnum2 {
    ...
    PositionConfidenceCodedErrorEnum2(String v) {
        value = v;
    }
    ...
    public static PositionConfidenceCodedErrorEnum2 fromValue(String v) {
        for (PositionConfidenceCodedErrorEnum2 c: PositionConfidenceCodedErrorEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
