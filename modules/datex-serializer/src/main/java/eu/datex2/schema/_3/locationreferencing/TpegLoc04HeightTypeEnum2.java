...
public enum TpegLoc04HeightTypeEnum2 {
    ...
    TpegLoc04HeightTypeEnum2(String v) {
        value = v;
    }
    ...
    public static TpegLoc04HeightTypeEnum2 fromValue(String v) {
        for (TpegLoc04HeightTypeEnum2 c: TpegLoc04HeightTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
