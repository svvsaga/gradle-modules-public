...
@XmlType(name = "_ReferentTypeEnum", propOrder = {
    "value"
})
public class _ReferentTypeEnum {

    @XmlValue
    protected ReferentTypeEnum value;
     ...
     *     
     */
    public ReferentTypeEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ReferentTypeEnum value) {
        this.value = value;
    }
