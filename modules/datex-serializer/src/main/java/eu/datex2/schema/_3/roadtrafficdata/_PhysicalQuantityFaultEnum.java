...
@XmlType(name = "_PhysicalQuantityFaultEnum", propOrder = {
    "value"
})
public class _PhysicalQuantityFaultEnum {

    @XmlValue
    protected PhysicalQuantityFaultEnum value;
     ...
     *     
     */
    public PhysicalQuantityFaultEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(PhysicalQuantityFaultEnum value) {
        this.value = value;
    }
