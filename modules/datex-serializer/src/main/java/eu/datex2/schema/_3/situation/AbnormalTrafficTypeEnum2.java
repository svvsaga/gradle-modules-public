 ...
 * 
 */
@XmlType(name = "AbnormalTrafficTypeEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum AbnormalTrafficTypeEnum2 {
    ...
    AbnormalTrafficTypeEnum2(String v) {
        value = v;
    }
    ...
    public static AbnormalTrafficTypeEnum2 fromValue(String v) {
        for (AbnormalTrafficTypeEnum2 c: AbnormalTrafficTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
