 ...
 * 
 */
@XmlType(name = "DelayBandEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum DelayBandEnum2 {
    ...
    public static DelayBandEnum2 fromValue(String v) {
        for (DelayBandEnum2 c: DelayBandEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
