 ...
 * 
 */
@XmlType(name = "DrivingConditionTypeEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum DrivingConditionTypeEnum2 {
    ...
    DrivingConditionTypeEnum2(String v) {
        value = v;
    }
    ...
    public static DrivingConditionTypeEnum2 fromValue(String v) {
        for (DrivingConditionTypeEnum2 c: DrivingConditionTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
