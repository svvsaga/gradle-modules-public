...
@XmlType(name = "MaintenanceWorks", namespace = "http://datex2.eu/schema/3/situation", propOrder = {
    "roadMaintenanceType",
    ...
    extends Roadworks
{
    ...
    @XmlElement(name = "_maintenanceWorksExtension", namespace = "http://datex2.eu/schema/3/situation")
