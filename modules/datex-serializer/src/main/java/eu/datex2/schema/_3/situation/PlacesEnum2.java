 ...
 * 
 */
@XmlType(name = "PlacesEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum PlacesEnum2 {
    ...
    public static PlacesEnum2 fromValue(String v) {
        for (PlacesEnum2 c: PlacesEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
