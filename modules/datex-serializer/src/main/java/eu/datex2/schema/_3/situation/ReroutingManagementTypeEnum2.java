...
public enum ReroutingManagementTypeEnum2 {
    ...
    ReroutingManagementTypeEnum2(String v) {
        value = v;
    }
    ...
    public static ReroutingManagementTypeEnum2 fromValue(String v) {
        for (ReroutingManagementTypeEnum2 c: ReroutingManagementTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
