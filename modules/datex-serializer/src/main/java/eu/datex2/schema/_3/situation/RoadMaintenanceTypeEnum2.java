 ...
 * 
 */
@XmlType(name = "RoadMaintenanceTypeEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum RoadMaintenanceTypeEnum2 {
    ...
    RoadMaintenanceTypeEnum2(String v) {
        value = v;
    }
    ...
    public static RoadMaintenanceTypeEnum2 fromValue(String v) {
        for (RoadMaintenanceTypeEnum2 c: RoadMaintenanceTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
