 ...
 * 
 */
@XmlType(name = "RoadOperatorServiceDisruptionTypeEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum RoadOperatorServiceDisruptionTypeEnum2 {
    ...
    RoadOperatorServiceDisruptionTypeEnum2(String v) {
        value = v;
    }
    ...
    public static RoadOperatorServiceDisruptionTypeEnum2 fromValue(String v) {
        for (RoadOperatorServiceDisruptionTypeEnum2 c: RoadOperatorServiceDisruptionTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
