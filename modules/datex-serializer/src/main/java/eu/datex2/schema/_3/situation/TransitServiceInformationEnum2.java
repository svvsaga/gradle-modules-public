 ...
 * 
 */
@XmlType(name = "TransitServiceInformationEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum TransitServiceInformationEnum2 {
    ...
    TransitServiceInformationEnum2(String v) {
        value = v;
    }
    ...
    public static TransitServiceInformationEnum2 fromValue(String v) {
        for (TransitServiceInformationEnum2 c: TransitServiceInformationEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
