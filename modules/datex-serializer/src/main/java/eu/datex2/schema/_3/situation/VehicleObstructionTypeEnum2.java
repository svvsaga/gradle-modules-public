 ...
 * 
 */
@XmlType(name = "VehicleObstructionTypeEnum", namespace = "http://datex2.eu/schema/3/situation")
@XmlEnum
public enum VehicleObstructionTypeEnum2 {
    ...
    VehicleObstructionTypeEnum2(String v) {
        value = v;
    }
    ...
    public static VehicleObstructionTypeEnum2 fromValue(String v) {
        for (VehicleObstructionTypeEnum2 c: VehicleObstructionTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
