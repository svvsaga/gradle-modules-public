...
@XmlType(name = "_RoadMaintenanceTypeEnum", propOrder = {
    "value"
})
public class _RoadMaintenanceTypeEnum {

    @XmlValue
    protected RoadMaintenanceTypeEnum value;
     ...
     *     
     */
    public RoadMaintenanceTypeEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(RoadMaintenanceTypeEnum value) {
        this.value = value;
    }
