...
@XmlType(name = "_RoadworksDurationEnum", propOrder = {
    "value"
})
public class _RoadworksDurationEnum {

    @XmlValue
    protected RoadworksDurationEnum value;
     ...
     *     
     */
    public RoadworksDurationEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(RoadworksDurationEnum value) {
        this.value = value;
    }
