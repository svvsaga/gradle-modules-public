...
@XmlType(name = "_ServiceDisruptionTypeEnum", propOrder = {
    "value"
})
public class _ServiceDisruptionTypeEnum {

    @XmlValue
    protected ServiceDisruptionTypeEnum value;
     ...
     *     
     */
    public ServiceDisruptionTypeEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ServiceDisruptionTypeEnum value) {
        this.value = value;
    }
