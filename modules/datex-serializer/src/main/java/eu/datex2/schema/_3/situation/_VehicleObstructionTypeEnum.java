...
public class _VehicleObstructionTypeEnum {

    @XmlValue
    protected VehicleObstructionTypeEnum value;
     ...
     *     
     */
    public VehicleObstructionTypeEnum getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(VehicleObstructionTypeEnum value) {
        this.value = value;
    }
