 ...
 * 
 */
@XmlType(name = "MessageInformationTypeEnum", namespace = "http://datex2.eu/schema/3/vms")
@XmlEnum
public enum MessageInformationTypeEnum2 {
    ...
    MessageInformationTypeEnum2(String v) {
        value = v;
    }
    ...
    public static MessageInformationTypeEnum2 fromValue(String v) {
        for (MessageInformationTypeEnum2 c: MessageInformationTypeEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
