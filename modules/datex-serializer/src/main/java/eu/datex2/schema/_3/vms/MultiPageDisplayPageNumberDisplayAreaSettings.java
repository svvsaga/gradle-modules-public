...
@XmlType(name = "_MultiPageDisplayPageNumberDisplayAreaSettings", namespace = "http://datex2.eu/schema/3/vms", propOrder = {
    "displayAreaSettings"
})
public class MultiPageDisplayPageNumberDisplayAreaSettings {
