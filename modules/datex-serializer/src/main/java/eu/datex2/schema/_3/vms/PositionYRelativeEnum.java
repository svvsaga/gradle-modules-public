...
@XmlEnum
public enum PositionYRelativeEnum {
    ...
    PositionYRelativeEnum(String v) {
        value = v;
    }
    ...
    public static PositionYRelativeEnum fromValue(String v) {
        for (PositionYRelativeEnum c: PositionYRelativeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
