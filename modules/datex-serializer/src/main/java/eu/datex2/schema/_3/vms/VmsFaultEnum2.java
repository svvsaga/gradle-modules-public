 ...
 * 
 */
@XmlType(name = "VmsFaultEnum", namespace = "http://datex2.eu/schema/3/vms")
@XmlEnum
public enum VmsFaultEnum2 {
    ...
    public static VmsFaultEnum2 fromValue(String v) {
        for (VmsFaultEnum2 c: VmsFaultEnum2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
