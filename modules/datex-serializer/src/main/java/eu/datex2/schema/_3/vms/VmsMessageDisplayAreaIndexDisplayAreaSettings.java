...
@XmlType(name = "_VmsMessageDisplayAreaIndexDisplayAreaSettings", namespace = "http://datex2.eu/schema/3/vms", propOrder = {
    "displayAreaSettings"
})
public class VmsMessageDisplayAreaIndexDisplayAreaSettings {
